...
See [Semantic Models](../semantic-models/) for the full reference.
...
Column profiling lives here, under a `profiles:` list — not as a `profiles` property inside a `MODEL(...)` block, which is deprecated.
