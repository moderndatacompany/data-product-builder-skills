MODEL (
  name LENOVO.USDK.hardware__@{rollup_type},
  kind FULL,
  owner 'shreyasikarwartmdcio',
  profiles (ROLLUP_TYPE, EVENT_DATE, ACTION, DEVICE_TYPE, PRODUCT_NAME, BRAND, REGION),
  tags ('gold', 'hardware-analytics', 'comprehensive-analytics', 'multi-dimensional', 'geographic-analytics', 'engagement-metrics', 'lenovo', 'usdk'),
  terms ('hardware_engagement', 'multi_dimensional_analytics', 'comprehensive_tracking', 'cumulative_metrics'),
  description 'Gold layer comprehensive hardware analytics aggregated by device type, geography, product, brand, and series. Primary hardware analytics table providing complete multi-dimensional view of device engagement across regions with cumulative metrics. Essential for cross-dimensional analysis and executive reporting.',
  grains (
    ROLLUP_TYPE, EVENT_DATE, ACTION, DEVICE_TYPE, PRODUCT_ID, PRODUCT_NAME, BRAND, SERIES, REGION, COUNTRY_NAME
  ),
  blueprints (
    (
