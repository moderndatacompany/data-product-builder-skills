...
MODEL (
  name nilus.vulcan.qualtrics_definition_flattened,
  ...
  terms ('qualtrics.question_dimension', 'survey.question_catalog', 'analytics.dimension'),
  column_descriptions (
  ...
  column_terms (
    ...
    question_type = ('qualtrics.question_type', 'question.type'),
