---
description: >-
  Macros make SQL dynamic with variables and functions. Overview of Vulcan
  macros, Jinja macros, and the predefined variables both systems share.
---
...
Data models are dynamic. You need different behavior depending on context, maybe filter by a different date each day, or include different columns based on configuration. Macros make this possible.
...
- [Vulcan macros](built-in.md) - Vulcan's native macro system with SQL-aware features
