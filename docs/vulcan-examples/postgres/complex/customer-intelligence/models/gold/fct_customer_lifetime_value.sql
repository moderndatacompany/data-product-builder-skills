...
lifetime_orders AS (
  SELECT
    ...
    (EXTRACT(YEAR FROM AGE(CURRENT_DATE, MIN(o."order_date"::DATE))) * 12
     + EXTRACT(MONTH FROM AGE(CURRENT_DATE, MIN(o."order_date"::DATE))))::INTEGER AS customer_tenure_months
