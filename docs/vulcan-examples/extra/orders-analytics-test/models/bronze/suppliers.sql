...
MODEL (
  name bronze_v1.suppliers,
  kind SEED (
    path '../../seeds/seed_suppliers.csv'
  ),
  columns (
    supplier_id INTEGER,
    region_id INTEGER,
  ...
  grains (supplier_id),
  tags ('dimension', 'supplier', 'supply_chain'),
  terms ('supplier.profile', 'supply_chain.supplier'),
