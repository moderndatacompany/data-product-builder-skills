MODEL (
  ...
  profiles (ROLLUP_TYPE, EVENT_DATE, ACTION, PRODUCT_ID, REGION, COUNTRY_NAME),
  tags ('gold', 'product-analytics', 'geographic-analytics', 'engagement-metrics', 'cumulative-metrics', 'lenovo', 'usdk', 'high-level'),
  terms ('product_engagement', 'geographic_distribution', 'regional_performance', 'cumulative_metrics'),
  description 'Gold layer high-level product analytics aggregated by geography. Provides simplified regional product performance view with cumulative engagement metrics across time windows. Essential for executive reporting, market performance analysis, and regional product adoption tracking without component-level detail.',
  grains (
    ROLLUP_TYPE, EVENT_DATE, ACTION, PRODUCT_ID, REGION, COUNTRY_NAME
  ),
  blueprints (
    (
