MODEL (
  ...
  profiles (ROLLUP_TYPE, EVENT_DATE, ACTION, COMPONENT_ID, COMPONENT_VERSION, REGION),
  tags ('gold', 'product-analytics', 'component-analytics', 'geographic-analytics', 'version-tracking', 'engagement-metrics', 'cumulative-metrics', 'lenovo', 'usdk'),
  terms ('product_engagement', 'component_version_adoption', 'geographic_distribution', 'cumulative_metrics'),
  description 'Gold layer product analytics aggregated by component version and geography. Tracks regional component version adoption with cumulative engagement metrics. Essential for regional version rollout analysis, geographic upgrade strategies, and market-specific component deployment insights.',
  grains (
    ROLLUP_TYPE, EVENT_DATE, ACTION, COMPONENT_ID, COMPONENT_VERSION, PRODUCT_ID, REGION, COUNTRY_NAME
  ),
  blueprints (
    (
