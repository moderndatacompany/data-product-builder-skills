MODEL (
  ...
  profiles (ROLLUP_TYPE, EVENT_DATE, ACTION, PRODUCT_NAME, PRODUCT_ID),
  tags ('gold', 'hardware-analytics', 'product-analytics', 'engagement-metrics', 'lenovo', 'usdk', 'aggregated'),
  terms ('hardware_engagement', 'product_analytics', 'product_performance', 'cumulative_metrics'),
  description 'Gold layer hardware analytics aggregated by product name. Provides high-level product performance metrics with cumulative engagement tracking across time windows. Essential for product portfolio analysis, adoption trends, and overall product success measurement.',
  grains (
    ROLLUP_TYPE, EVENT_DATE, ACTION, PRODUCT_NAME, PRODUCT_ID
  ),
  blueprints (
    (
