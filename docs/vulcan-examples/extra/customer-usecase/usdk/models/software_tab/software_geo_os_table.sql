MODEL (
  ...
  tags ('gold', 'software-analytics', 'os-analytics', 'geographic-analytics', 'engagement-metrics', 'cumulative-metrics', 'lenovo', 'usdk'),
  terms ('software_engagement', 'os_distribution', 'geographic_distribution', 'cumulative_metrics'),
  description 'Gold layer software analytics with cumulative metrics aggregated by OS family, product, and geography. Tracks cumulative engagement patterns across different Windows versions and regions. Essential for OS adoption trends, regional market penetration analysis, and long-term growth tracking.',
  grains (
    ROLLUP_TYPE, EVENT_DATE, ACTION, OS_FAMILY, PRODUCT_ID, REGION, COUNTRY_NAME
  ),
  blueprints (
    (
